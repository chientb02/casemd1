...
function showMonAn(arr) {
   ...
   <div  class="sanPham"  style="float:left ; width: 280px; height: 480px ; border: 1px solid #BEBEBE ;">
            ...
            <h3>${arr[i].ten}</h3>
             ...
             <p>${arr[i].thongTin}</p>`
            if(name!= null){
                showCombo +=  `<button id= "\oncombo${i}\"  onclick="editCombo(${i})" style="display:block;">Edit</button>
             <button id= "\oncombo1${i}\"  onclick="deleteCombo(${i})" style="display: block;">Delete</button>`
            }
            else{
                showCombo += `<button id= "\oncombo${i}\"  onclick="editCombo(${i})" style="display:none;">Edit</button>
             <button id= "\oncombo1${i}\"  onclick="deleteCombo(${i})" style="display: none;">Delete</button>
...
function showMonAn1(arr) {
   ...
   <div  class="sanPham"  style="float:left ; width: 280px; height: 480px ; border: 1px solid #BEBEBE ;">
            ...
            <h3>${arr[i].ten}</h3>
             ...
             <p>${arr[i].thongTin}</p>`
        if(name!= null){
            showdsMonMoi +=  `<button  onclick="editdsMonMoi(${i})" style="display:block;">Edit</button>
             <button  onclick="deletedsMonMoi(${i})" style="display: block;">Delete</button>`
        }
        else {
            showdsMonMoi += `<button  onclick="editdsMonMoi(${i})" style="display:none;">Edit</button>
             <button  onclick="deletedsMonMoi(${i})" style="display: none;">Delete</button>
                <button  style="background-color:#EEEEEE;color:#BEBEBE;border:none; width:215px; height:auto ;margin:10px; border-radius:20px;"> <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
  <path d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z"/>
  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zm3.915 10L3.102 4h10.796l-1.313 7h-8.17zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
</svg></button>`
...
function showMonAn2(arr) {
   ...
   <div  class="sanPham"  style="float:left ; width: 280px; height: 480px ; border: 1px solid #BEBEBE ;">
            ...
            <h3>${arr[i].ten}</h3>
             ...
             <p>${arr[i].thongTin}</p>`
        if(name!= null){
            showdsMonMoi +=  `<button  onclick="editdsGaRan(${i})" style="display:block;">Edit</button>
             <button  onclick="deletedsGaRan(${i})" style="display: block;">Delete</button>`
        }
        else {
            showdsMonMoi += `<button  onclick="editdsGaRan(${i})" style="display:none;">Edit</button>
             <button  onclick="deletedsGaRan(${i})" style="display: none;">Delete</button>
                <button  style="background-color:#EEEEEE;color:#BEBEBE;border:none; width:215px; height:auto ;margin:10px; border-radius:20px;"> <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
  <path d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z"/>
  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zm3.915 10L3.102 4h10.796l-1.313 7h-8.17zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
</svg></button>`
